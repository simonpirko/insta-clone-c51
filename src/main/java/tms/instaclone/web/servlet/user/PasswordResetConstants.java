...
public class PasswordResetConstants {
    ...
    //links to servlet
    public static final String PASSWORD_RESET_LINK = "/passwordReset";

    //links to servlet name
    public static final String PASSWORD_RESET_NAME_SERVLET = "PasswordResetServlet";
