...
public final class ServletConstants {
    ...
    public static final String PATH_PASSWORD_RESET_PAGE_JSP = "/page/accounts/login/passwordResetPage.jsp";
    ...
    public static final String URL_PASSWORD_RESET_SERVLET = "/passwordReset";
